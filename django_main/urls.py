...
urlpatterns = [
    ...
    path('refund_order/',myviews.refund_order),
    path('refund_cancel/',myviews.refund_cancel),
    path('rework_order/',myviews.rework_order),
    path('rework_cancel/',myviews.rework_cancel),
    path('draw_agin_end/',myviews.draw_agin_end),
    path('ruku_print/',myviews.ruku_print),
    path('cl_out_sku/',myviews.cl_out_sku),
    path('clout_order_save/',myviews.clout_order_save),
    path('Stock_account/',myviews.Stock_account),
    path('preview_order/',myviews.preview_order),
]
